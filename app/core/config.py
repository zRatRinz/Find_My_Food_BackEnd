...
GOOGLE_GEN_CONTENT_MODEL = os.getenv("GOOGLE_GEN_CONTENT_MODEL")
GOOGLE_ANALIZE_IMG_MODEL = os.getenv("GOOGLE_ANALIZE_IMG_MODEL")
GOOGLE_IMG_GEN_MODEL = os.getenv("GOOGLE_IMG_GEN_MODEL")
