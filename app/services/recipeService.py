...
MEDIUM_WEIGHT_WORDS = {
    "หมู", "ไก่", "เนื้อ", "ปลา", "กุ้ง", "หมึก", "ทะเล", "หอย", "ปู", "ไข่", 
    "เต้าหู้", "ปลากระป๋อง", "หมูสับ", "ไก่สับ", "เนื้อสับ", "หมูชิ้น", "ไก่ชิ้น", 
    "ลูกชิ้น", "หมูยอ", "กุนเชียง", "ไส้กรอก", "แฮม", "เบคอน", "วุ้นเส้น", "ผัก"
}
HIGH_VALUE_WORDS = {
    "มัสมั่น", "กะเพรา", "ต้มยำ", "ผัดไทย", "ขี้เมา", "เขียวหวาน", "ส้มตำ", 
    "ราดหน้า", "สุกี้", "ซีอิ๊ว", "หมูแดง", "หมูกรอบ", "สามชั้น", "ผงกะหรี่", 
    "ผัดฉ่า", "ยำ", "แซ่บ", "แกงส้ม", "แกงเหลือง", "ข้าวซอย", "อเมริกัน",
    "กระเทียม", "พริกแกง", "คะน้า", "ไข่เจียว", "ลาบ", "น้ำตก", "ข้าวมันไก่", 
    "ข้าวหมก", "พะแนง", "ต้มข่า", "คั่วกลิ้ง", "แกงป่า", "ต้มแซ่บ", "เปรี้ยวหวาน", 
    "หมาล่า", "เทอริยากิ", "สปาเก็ตตี้", "มักกะโรนี", "เต้าเจี้ยว", "พริกไทยดำ"
}
